...
if __name__ == '__main__':
    ...
    utils.run_conjugate_priors(
        ...
        log_folder_name = f"logs/simulated_data_conjugate_priors",
        img_folder_name = f"img/simulated_data_conjugate_priors",
        n_shuffle = n_shuffle,
        burn_in = burn_in, 
        thining = thining,
    )
    ...
    utils.run_soft_kmeans(
        ...
        iterations=iterations,
        n_shuffle = n_shuffle,
        log_folder_name = f"logs/simulated_data_soft_kmeans", 
        img_folder_name = f"img/simulated_data_soft_kmeans",
        burn_in = burn_in, 
        thining = thining,
    )
    # Soley kmeans
    utils.run_kmeans(
        ...
        iterations=iterations,
        n_shuffle = n_shuffle,
        log_folder_name = f"logs/simulated_data_kmeans", 
        img_folder_name = f"img/simulated_data_kmeans",
    ...
    utils.run_conjugate_priors(
        data_we_have = participants_data,
        iterations=iterations,
        log_folder_name = f"logs/chen_data_conjugate_priors", 
        img_folder_name = f"img/chen_data_conjugate_priors",
        n_shuffle=n_shuffle,
        burn_in = burn_in, 
        thining = thining,
        chen_data=True,
    ...
    utils.run_soft_kmeans(
        ...
        iterations=iterations,
        n_shuffle = n_shuffle,
        log_folder_name = f"logs/chen_data_soft_kmeans", 
        img_folder_name = f"img/chen_data_soft_kmeans",
        burn_in = burn_in, 
        thining = thining,
        chen_data=True,
    )
    ...
    utils.run_kmeans(
        ...
        iterations=iterations,
        n_shuffle = n_shuffle,
        log_folder_name = f"logs/chen_data_kmeans", 
        img_folder_name = f"img/chen_data_kmeans",
        real_order = real_order,
        burn_in = burn_in, 
        thining = thining,
        chen_data=True,
